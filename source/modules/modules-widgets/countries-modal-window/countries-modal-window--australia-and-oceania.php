...
<div id="modal-windows__countries--australia-and-oceania-list" class="modal">
  ...
  <div class="modal-content">
    <div class="modal-header">
      <span class="close"  id="countries--australia-and-oceania__modal-window-close-button">&times;</span>
    </div>
    <div class="">
      <ul>
        ...
        <li>
          <label class="custom-checkbox__label">
            <span id="regions-australia--label-text-id">Австралия</span>
        ...
        <li>
          <label class="custom-checkbox__label">
            <span id="regions-fiji--label-text-id">Фиджи</span>
        ...
        <li>
          <label class="custom-checkbox__label">
            <span id="regions-hawaii--label-text-id">Гавайи</span>
        ...
        <li>
          <label class="custom-checkbox__label">
            <span id="regions-new-zealand--label-text-id">Новая Зеландия</span>
