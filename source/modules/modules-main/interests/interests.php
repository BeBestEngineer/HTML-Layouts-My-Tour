<div class="  flex__container  flex__item--stretch">
  <main class="main-modules  main-modules--interests  flex__container  grid__container--medium">
      ...
      <div class="flex__item--equal-width  grid__col">
        ...
        <a class="links" href="#">
          <svg enable-background="new 0 0 30 30" height="18px" viewBox="0 0 30 30" width="18px" >
  ...
  <nav class="flex__item--order--1  flex__item--stretch  grid__col">
    HolyGrail-nav
  </nav>


  <aside class="flex__item--stretch  grid__col">
    HolyGrail-ads
  </aside>
</div>