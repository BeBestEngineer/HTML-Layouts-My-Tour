  ...
  <div class="grid__container--large">
    <div class="flex__container  ">
      <div class="flex__item--equal-width  grid__col">
        ...
        <a class="links" href="#">Показать на карте</a>
      </div>
      ...
      <div class="flex__item--equal-width  grid__col">
        ...
        <a class="links" href="#">Обратная связь</a>
      </div>
      ...
      <div class="flex__item--equal-width  grid__col">
        <ul class="social-links-list">
          <li>
            <a class="links" href="#">
              <svg class="social-links-list__icon  icons__svg--text  allign-middle" width="20" height="20" viewBox="0 0 1792 1792">
          ...
          <li>
            <a class="links" href="#">
              <svg class="social-links-list__icon  icons__svg--text  allign-middle" enable-background="new 0 0 30 30" height="18px" viewBox="0 0 30 30" width="18px">
